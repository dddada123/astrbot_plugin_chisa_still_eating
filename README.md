...
当前版本：**4.2.4** 🎉 云端皮肤印象色_Astrbot商店审核版 | 作者：Rua432
...
## 特别鸣谢
·感谢 [NTidal](https://github.com/NTidal) 移植的 NekroAgent 版本 —— [Nekro-Chisa-Still-Eating](https://github.com/NTidal/Nekro-Chisa-Still-Eating)
...
4.2.4 支持从官方及第三方 `skin/index.json` 条目读取安全的两色预览变量 `--primary` / `--bg` 和商品简介 `desc`。未下载皮肤现在可以在商店卡片上显示自己的主题色块与简介，不再统一回退成当前正在使用皮肤的颜色；下载后的卡片继续读取完整配置中的 `desc`。
